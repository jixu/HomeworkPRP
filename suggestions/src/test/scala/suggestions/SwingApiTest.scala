...
class SwingApiTest extends FunSuite {
  ...
  test("SwingApi should emit button field values to the observable") {
    ...
    assert(observed == Seq(button1, button2, button1, button2), observed)
  }
}